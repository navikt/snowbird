...
Se [tests/snowflake.yml](tests/snowflake.yml) for et eksempel på hvordan en konfigurasjonsfil skal fylles ut. For full spesifikasjon se [REFERENCES.md](./REFERENCES.md)

## snowflake.yml validation

Installer [YAML extension fra Red Hat](https://marketplace.visualstudio.com/items?itemName=redhat.vscode-yaml) i vscode

Legg følgende til i `.vscode/settings.json`:
...
## Oppdatere REFERENCES.md og COMMANDS.md

Etter endringer i [snowflake.schema.json](snowflake.schema.json) eller i cli api'et kan dokumentasjon oppdateres med `make docs`
