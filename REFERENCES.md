...
| grants[].usage_on_schemas | `array` |  | [`^[a-zA-Z0-9_]+\.[a-zA-Z0-9_]+$`](https://regex101.com/?regex=%5E%5Ba-zA-Z0-9_%5D%2B%5C.%5Ba-zA-Z0-9_%5D%2B%24) |  |  | Schemas to grant USAGE access on (without read or write). Format: 'database.schema'. |  |
...
| grants[].read_on_tables | `array` |  | [`^[a-zA-Z0-9_]+\.[a-zA-Z0-9_]+\.[a-zA-Z0-9_]+$`](https://regex101.com/?regex=%5E%5Ba-zA-Z0-9_%5D%2B%5C.%5Ba-zA-Z0-9_%5D%2B%5C.%5Ba-zA-Z0-9_%5D%2B%24) |  |  | Specific tables to grant SELECT access on. Format: 'database.schema.table_name'. |  |
